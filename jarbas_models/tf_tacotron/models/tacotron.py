...
from tensorflow.contrib.seq2seq import BasicDecoder, BahdanauAttention, \
    AttentionWrapper
from jarbas_models.tf_tacotron.text.symbols import symbols
from jarbas_models.tf_tacotron.util.infolog import log
from jarbas_models.tf_tacotron.models.helpers import TacoTestHelper, \
    TacoTrainingHelper
from jarbas_models.tf_tacotron.models.modules import encoder_cbhg, \
    post_cbhg, prenet
from jarbas_models.tf_tacotron.models.rnn_wrappers import \
...
class Tacotron():
    ...
    def initialize(self, inputs, input_lengths, mel_targets=None,
        ...
        with tf.variable_scope('inference') as scope:
            ...
            mel_outputs = tf.reshape(decoder_outputs, [batch_size, -1,
                                                       hp.num_mels])  # [N, T_out, M]
    ...
    def add_loss(self):
        ...
        with tf.variable_scope('loss') as scope:
            ...
            self.linear_loss = 0.5 * tf.reduce_mean(
                l1) + 0.5 * tf.reduce_mean(l1[:, :, 0:n_priority_freq])
...
def _learning_rate_decay(init_lr, global_step):
    ...
    return init_lr * warmup_steps ** 0.5 * tf.minimum(
